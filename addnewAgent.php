...
<nav class="w3-sidebar w3-bar-block w3-white w3-collapse w3-top w3-card" style="z-index:3;width:250px; margin-top:70px;" id="mySidebar">
  ...
  <div class="w3-medium">
     ...
     <a href="addnewAgent.php" class="w3-bar-item w3-left-align w3-black" style="text-decoration: none;">Add new agent</a>
  ...
  <div class="w3-container">
    <?php
      if(isset($_POST['addagent'])){
        echo $_SESSION['msgAddAgent'];
      }
    ?>
    <div class="w3-card w3-margin-top w3-border w3-border-green" ng-show="addNewAgent" id="addNewAgent" >
      <h4 id="header" class="w3-container w3-green w3-padding-large">Add new agent </h4>
      <section class="w3-margin-top w3-margin-bottom w3-padding-large" >
    	 	 			<form action="<?php echo htmlspecialchars($_SERVER['PHP_SELF']); ?>" method="post" enctype="multipart/form-data">
                <div class="w3-container w3-margin-bottom">
                  <label>ID</label>
                  <input type="text" name="id" class="w3-input" required>
                </div>
                <div class="w3-row">
                ...
                <div class="w3-row">
                  <div class="w3-col m6 w3-container w3-margin-bottom">
                    <label>Phone 2 <span class="w3-tiny">(optional)</span></label>
                    <input type="text" name="phone2" class="w3-input">
                  </div>
                  <div class="w3-col m6 w3-container w3-margin-bottom">
                    <label>Blood group</label>
                    <input type="text" name="bloodGroup" class="w3-input" required>
                  </div>
                </div>
                <div class="w3-row">
                  <div class="w3-container w3-margin-bottom">
      	 	 				...
      	 	 				<div class="w3-row" style="padding:8px 0px;">
      	 	 					<div class="w3-col s4">
      	 	 						<div class="upload-btn-wrapper">
      									...
      									<input type="file" accept="image/*" name="image" onchange="preview_image2(event)">
      								</div>
      	 	 					</div>
      							<div class="w3-col s8">
      							    <button type="submit" name="addagent"  class="w3-btn w3-green w3-right">Save</button>
      	 	 					</div>
      	 	 				</div>
                  <img id="output_image2"/ style="width:200px; padding:0px 8px 8px 0px;">
                </div>
    	 	 			</form>
    	</section>
    </div>
